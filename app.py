    ...
    try:
        ...
        if 'summary' in excel_obj.sheet_names:
            ...
            for _, r in df_sum_file.dropna(subset=[ch_c]).iterrows():
                c_raw = str(r[ch_c]).strip()
                c_name = '7-11' if any(k in c_raw for k in ['07-11', '7-11', '7/11', '2026-07-11']) else c_raw
        ...
        # 5. CHANNEL SUMMARY (INCLUDING UNVISITED TARGET SHOPS)
